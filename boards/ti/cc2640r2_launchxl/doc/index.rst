.. zephyr:board:: cc2640r2_launchxl

Overview
********

The Texas Instruments CC2640R2 LaunchPad |trade| (LAUNCHXL-CC2640R2) is a
development kit for the SimpleLink |trade| multi-Standard CC26xx wireless MCU.

See the `TI CC2640 LaunchPad Product Page`_ for details.

Hardware
********

The CC2640R2 LaunchPad |trade| development kit features the CC26xx wireless MCU.
...
The CC26xx wireless MCU has a 48 MHz Arm |reg| Cortex |reg|-M3 SoC and an
integrated 2.4 GHz transceiver supporting multiple protocols including Bluetooth
|reg| Low Energy and IEEE |reg| 802.15.4.

See the `TI CC2640R2F Product Page`_ for additional details.
...
Applications for the ``CC2640R2 LaunchPad`` board configuration can be built and
...
CC13x0 / CC26x0 Technical Reference Manual`_ for additional information.
...
CC2640R2F LaunchPad Quick Start Guide:
  http://www.ti.com/lit/pdf/swru528

.. _TI CC2640 LaunchPad Product Page:
   https://www.ti.com/tool/LAUNCHXL-CC2640R2

.. _TI CC2640R2F Product Page:
   https://www.ti.com/product/CC2640R2F

.. _TI CC2640R2F LaunchPad Quick Start Guide:
   https://www.ti.com/lit/pdf/SWRU500

.. _TI CC2640R2F Datasheet:
   https://www.ti.com/lit/gpn/cc2640r2f

.. _TI CC13x0 / CC26x0 Technical Reference Manual:
